...
<template>
 <div class="w-full">
        <article class=" flex flex-wrap md:flex-nowrap shadow-lg mx-auto max-w-3xl group cursor-pointer transform duration-500 hover:-translate-y-1">
          <img class="w-full md:w-52" :src="place.photo" alt="">
          <div class="">
            <div class="p-5 pb-10">
            ...
            <div class="bg-blue-50 p-5">
              <div class="sm:flex sm:justify-between">
                <div>
                  <div class="text-lg text-gray-700">
                    <span class="text-gray-900 font-bold">{{ place.distance }}</span> from Dhaka
                  </div>
              ...
              <div class="mt-3 text-gray-600 text-sm md:text-sm">
                *Places to visit: <template v-for="(spot, index) in place.places" :key="index">
                  {{ spot }} ,
                </template>
              </div>
            </div>
